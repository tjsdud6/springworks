...
public class BoardDAO {
	...
	//sql 쿼리 상수 선언
	private final String BOARD_INSERT = "INSERT INTO board(bno, title, writer, content) "
			+ "VALUES(seq.nextval, ?, ?, ?)";
	private final String BOARD_LIST = "SELECT * FROM board ORDER BY bno DESC";
	private final String BOARD_ONE = "SELECT * FROM board WHERE bno = ?";
